...
import heroBcg2 from '../assets/hero-2.png'
  ...
  return (
    <Wrapper className="section-center">
      ...
      <article className="img-container">
        <img src={heroBcg} alt="nice home appliance" className="main-img"/>
        <img src={heroBcg2} alt="personal working" className="accent-img"/>
      </article>
    </Wrapper>
  )
}
